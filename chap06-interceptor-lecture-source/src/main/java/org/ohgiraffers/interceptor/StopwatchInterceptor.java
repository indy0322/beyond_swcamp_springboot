...
public class StopwatchInterceptor implements HandlerInterceptor {
    ...
    @Autowired
    public void setTestService(InterceptorTestService testService) {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        /* 설명. 핸들러 인터셉트의 preHandler이 반환하는 boolean형에 따라 Controller의 핸들러 메소드 동작여부 조절 가능 */
        return true;
    }
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        ...
        /* 설명. postHandle의 ModelAndView는 Controller의 핸들러 메소드가 반환한 내용(재료) + 뷰가 담겨있다. */
