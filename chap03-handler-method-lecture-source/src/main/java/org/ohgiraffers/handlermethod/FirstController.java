...
//        model.addAttribute("category", categoryCode);
    ...
    * */
    @PostMapping("modify1")
    public String modifyMenu1(Model model, @RequestParam(name = "modifyName", defaultValue = "디폴트") String modifyName, @RequestParam(name = "modifyPrice", defaultValue = "0") int modifyPrice) {
     ...
     *
     * 설명.
     *  @ModelAttribute 어노테이션을 활용하면 커맨드 객체를 모데르의 attribute에 바로 담아주며 이후
