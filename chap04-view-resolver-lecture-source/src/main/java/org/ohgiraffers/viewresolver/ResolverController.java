...
public class ResolverController {
    ...
    * */
    ...
    public String stringRedirectFlashAttr(RedirectAttributes rttr){
        ...
        /* 설명. 스프링부터에서 리다이렉트 시에 값이 전달되게 하고 싶다면 RedirectAttributes에 Flash Attribute로 추가한다. */
        /* 설명. 추가로 내부적으로는 HttpSession을 활용하기 떄문에 Flash Attryibute 키 값이 기존 session의 키 값과 중복되면 X */
    ...
    /* 설명. forward 시에는 Model에 재료를, redirect 시에는 RedirectAttribute에 재료를 담는다. */
    ...
    public ModelAndView modelAndViewRedirect(ModelAndView mv){
        ...
        /* 설명. url 경로 상에 쿼리스트링 형태로 파라미터로 넘어간다. */
